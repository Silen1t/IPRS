...
{
    Task<ServiceResult<PurchaseRequestResponse>> CreateRequestAsync(CreatePurchaseRequestDto requestDto, Guid userId);
    ...
    Task<ServiceResult<PurchaseRequestResponse>> EditRequestAsync(Guid id, UpdatePurchaseRequestDto requestDto, Guid userId);
    ...
    Task<ServiceResult<PurchaseRequestResponse>> FinanceApproveAsync(Guid id, FinanceApproveDto dto, Guid financeUserId);
    Task<ServiceResult<PurchaseRequestResponse>> FinanceRejectAsync(Guid id, FinanceRejectDto dto, Guid financeUserId);
}