        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeId = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManagerActionById = table.Column<Guid>(type: "uuid", nullable: true),
                    ManagerActionAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ManagerNote = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    FinanceActionById = table.Column<Guid>(type: "uuid", nullable: true),
                    FinanceActionAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    FinanceNote = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    PurchaseOrderNumber = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseRequests", x => x.Id);
                    table.CheckConstraint("CK_PurchaseRequest_Description_For_High_Value", "\"TotalPrice\" <= 50000 OR (\"Description\" IS NOT NULL AND LENGTH(TRIM(\"Description\")) > 0)");
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchaseRequests_Users_FinanceActionById",
                        column: x => x.FinanceActionById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchaseRequests_Users_ManagerActionById",
                        column: x => x.ManagerActionById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notifications_PurchaseRequests_RelatedRequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseRequests_FinanceActionById",
                table: "PurchaseRequests",
                column: "FinanceActionById");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseRequests_ManagerActionById",
                table: "PurchaseRequests",
                column: "ManagerActionById");
